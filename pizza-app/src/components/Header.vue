  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <ul class="navbar-nav ml-auto">
        <li>
          <router-link :to="{name:'login'}" v-show="!isLogin" class="nav-link">登录</router-link>
        </li>

        <li class="nav-link">{{currenUser}}</li>

        <li>
          <router-link :to="{name:'login'}" v-show="isLogin" class="nav-link">[退出]</router-link>
        </li>
